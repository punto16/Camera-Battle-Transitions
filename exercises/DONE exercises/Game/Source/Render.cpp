...
// Blit to screen
bool Render::DrawTexture(SDL_Texture* texture, int x, int y, SDL_Renderer* renderer, const SDL_Rect* section, float scale, float speed, double angle, int pivotX, int pivotY) const
{
	bool ret = true;
